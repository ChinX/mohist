...
func TestAddMatch(t *testing.T) {
	n := newNode()
	n.add("/accounts/", func(w http.ResponseWriter, req *http.Request) {
		t.Log("one")
	})
	n.add("accounts/:account", func(w http.ResponseWriter, req *http.Request) {
		t.Log("two")
	})
	n.add("accounts/:account/projects", func(w http.ResponseWriter, req *http.Request) {
		t.Log("three")
	})
	n.add("accounts/:account/projects/:project", func(w http.ResponseWriter, req *http.Request) {
		t.Log("four")
	})

	n.add("accounts/:account/projects/abcde", func(w http.ResponseWriter, req *http.Request) {
		t.Log("five")
	})

	n.add("accounts/:account/projects/:project/files/?:file", func(w http.ResponseWriter, req *http.Request) {
		t.Log("six")
	})
